...
def prepare_export_data(multiworld) -> Dict[str, Any]:
    ...
    Now preserves helper function references instead of expanding them.
    """
    locations_export = {}
    items_export = {}
    item_groups_export = {}
...
def _process_locations(multiworld, player) -> Dict[str, Any]:
    """Process location data including rules. Now preserves helper references."""
...
def _process_progression_mapping(multiworld, player) -> Dict[str, Any]:
    """Extract progression mapping data."""
