...
| json | json | JSON | jsonPanel | 📄 | Left | Manages loading, combining,... | ❌ | ❌ | ❌ |
| locations | locations | Locations | locationsPanel | 📍 | Right | Locations display panel. | ❌ | ❌ | ❌ |
| loops | loops | Loops | loopsPanel | 🔄 | Right | Loop mode logic and UI panel. | ❌ | ❌ | ❌ |
...
| playerStatePanel | playerStatePanel | Player State | playerStatePanel | 👤 | Middle | Player State display panel. | ❌ | ❌ | ❌ |
...
| windowAdapter | windowAdapter | ❌ | ❌ | ❌ | ❌ | Adapter for window-based mo... | ❌ | ❌ | ❌ |
